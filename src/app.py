...
activities = {
    ...
    "Digital Art Studio": {
        "description": "Create digital artwork using design software and graphic design tools",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["taylor@mergington.edu"]
    },
    "Theater Production": {
        "description": "Act in school plays and musicals, learn stage performance skills",
